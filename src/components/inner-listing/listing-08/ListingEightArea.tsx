...
const ListingEightArea = ({ style }: any) => {
  ...
  return (
    <div
      className={`property-listing-six pb-200 xl-pb-120 ${style ? "pt-120 xl-pt-100" : "pt-200 xl-pt-150"}`}
    >
      <div className="container container-large">
        ...
        <div
          className={`listing-header-filter d-sm-flex justify-content-between align-items-center lg-mb-30 ${style ? "mb-50" : "mb-40"}`}
        >
          <div>
            Showing{" "}
          ...
          >
            <div className="d-flex flex-wrap layout-two">
              ...
              <div className="property-info">
                <Link href="/listing_details_01" className="title tran3s mb-15">
                  {item.title}
                </Link>
                ...
                <div className="feature border-0 mt-55 md-mt-40 mb-35 md-mb-20">
                  <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <li>
                      <strong>{item.property_info.parking_lot}</strong> Parking
                      Lot
                    </li>
                    <li>
