...
const ListingTwoArea = ({ style }: any) => {
  ...
  return (
    <div
      className={`property-listing-six ${style ? "pt-150 xl-pt-100 pb-170 xl-pb-120" : "bg-pink-two pt-110 md-pt-80 pb-150 xl-pb-120 mt-150 xl-mt-120"}`}
    >
          ...
          <div className="col-lg-8">
            <div className="ps-xxl-5">
              ...
              {currentItems.map((item: any) => (
                <div
                  key={item.id}
                  className={`listing-card-seven border-20 p-20 mb-50 wow fadeInUp ${style ? "grey-bg" : ""}`}
                >
