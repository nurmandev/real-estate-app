              ...
              <div className="row gx-0 align-items-center">
                  ...
                  <div className="input-box-one">
                    ...
                    <NiceSelect
                      ...
                      options={[
                        ...
                        { value: "2", text: "AED 20,000 - AED 300,000" },
                        { value: "3", text: "AED 30,000 - AED 400,000" },
                      ]}
                      defaultCurrent={0}
                      onChange={selectHandler}
                      name=""
                ...
                <div className="col-xl-2 col-lg-1">
                  <div className="input-box-one p0 ms-xl-5 md-mt-20">
                    <button className="fw-500 text-uppercase tran3s search-btn-two w-100 h-100 pt-45 lg-pt-30 md-pt-20 pb-45 lg-pb-30 md-pb-20 fs-2">
