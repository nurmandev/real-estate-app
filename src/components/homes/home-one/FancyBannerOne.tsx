...
const FancyBannerOne = ({ style }: any) => {
  return (
    <div
      className={`fancy-banner-one position-relative z-1 pt-160 xl-pt-140 lg-pt-80 pb-140 xl-pb-120 lg-pb-100 ${style ? "mt-200 xl-mt-150 lg-mt-120" : ""}`}
    >
              ...
              <div className="row gx-0">
                ...
                <div className="col-md-7 d-flex">
                  <div className="gutter w-100 h-100">
                    ...
                    <h2 className="price text-center">AED 28,100.00</h2>
