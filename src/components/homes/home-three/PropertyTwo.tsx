      ...
      <div className="container container-large">
        <div className="position-relative z-1">
          <div className="title-one mb-60 lg-mb-40 wow fadeInUp">
            <h2 className="font-garamond">
              ...
              <span className="star-shape">
                <Image src={propertyShape_1} alt="" className="lazy-img" />
              </span>
            </h2>
                ...
                <div key={item.id} className="item">
                  <div className="listing-card-one style-three border-30 mb-50">
                    ...
                    <div className="property-info pe-4 ps-4">
                      <Link href="/listing_details_04" className="title tran3s">
                        {item.title}
                      </Link>
                        ...
                        {item.property_info.map((info, i) => (
                          <li key={i} className="d-flex align-items-center">
                            <span className="fs-16">
                              <strong className="fw-500 color-dark">
                                {info.feature}
                              </strong>{" "}
                              {info.total_feature}
                            </span>
          ...
          <div className="section-btn text-center">
            <Link href="/listing_04" className="btn-eleven fst-italic">
              <span>See all properties</span>
            </Link>
          </div>
          <ul className="slider-arrows slick-arrow-two d-flex justify-content-center style-none md-mt-30">
            <li onClick={handlePrevClick} className="prev_b slick-arrow">
              <i className="bi bi-arrow-left"></i>
            </li>
            <li onClick={handleNextClick} className="next_b slick-arrow">
