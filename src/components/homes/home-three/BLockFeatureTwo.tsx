              ...
              <div className="pe-xl-5 me-xxl-3 wow fadeInLeft">
                <div className="title-one pe-xl-5">
                  <h2 className="font-garamond">
                    Explore & Find your <em>Dream</em> home{" "}
                    <span className="star-shape">
                      <Image src={featureimg_1} alt="" className="lazy-img" />
                    </span>
                  </h2>
                </div>
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="block-two ps-xxl-5 md-mt-100">
                <div className="bg-wrapper wow fadeInRight">
                  <p className="fs-24 fst-italic pe-xl-5">
                    “Your premier partner in real estate. Transforming
                  ...
                  <div className="mt-70 lg-mt-50">
                    <Link href="/about_us_02" className="btn-five md">
