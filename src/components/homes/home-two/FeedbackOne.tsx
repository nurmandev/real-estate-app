          ...
          <div className="col-lg-8 order-lg-last">
            <div className="main-content position-relative z-1">
              <div className="feedback-block-two">
                <blockquote className="font-garamond text-white">
                  &quot;Extraordinary <span>performance!</span> Quick solutions.
                  Highly recommended.&quot;
                </blockquote>
                <div className="d-flex align-items-center mt-75 md-mt-60">
                  ...
                  />
                  <div className="ps-4">
                    <h6 className="fs-22 text-white fw-normal mb-5">
                      Ahmad Aljamal.
                    </h6>
                    <span className="text-white opacity-50 fw-light">
                      CEO & Head of OMNIS Inc
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-lg-12 col-md-6">
                  <div className="counter-block-two mb-85 xl-mb-50 md-mb-40">
                    <div className="main-count font-garamond fw-500">
                      <span className="counter">
                        <Count number={500} />
                      </span>
                      +
                    </div>
                    <p className="fs-20 fw-light m0">Premium Listings</p>
                  </div>
                </div>
                <div className="col-lg-12 col-md-6">
                  <div className="counter-block-two md-mb-40">
                    ...
                    <p className="fs-20 fw-light m0">Global Investors</p>
                  </div>
                </div>
              </div>
            </div>
