...
const score_data: DataType[] = [
  {
    ...
    desc: (
      <>
        <span className="color-dark">63</span>/100 (Moderate Distance Walkable)
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        <span className="color-dark">70</span>/100 (Short Distance Walkable)
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        <span className="color-dark">77</span>/100 (Short Distance Walkable)
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        <span className="color-dark">42</span>/100 (Long Distance Walkable)
      </>
    ),
  },
];

const CommonProPertyScore = ({ property }: any) => {
  return (
    <>
      <h4 className="mb-20">Walk Score</h4>
      <p className="fs-20 lh-lg pb-30">
        Scores for various services around {property?.title || "this property"}.
      </p>
      <div className="row">
        {score_data.map((item) => (
