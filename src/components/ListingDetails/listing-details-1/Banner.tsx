    ...
    <div className="row">
      ...
      <div className="col-lg-6 text-lg-end">
        <div className="d-inline-block md-mt-40">
          <div className="price color-dark fw-500">Price: AED 1,67,000</div>
          <div className="est-price fs-20 mt-25 mb-35 md-mb-30">
            Est. Payment{" "}
            <span className="fw-500 color-dark">AED 8,343/mo*</span>
          </div>
          <ul className="style-none d-flex align-items-center action-btns">
            ...
            <li>
              <Link
                href="#"
                className="d-flex align-items-center justify-content-center rounded-circle tran3s"
              >
