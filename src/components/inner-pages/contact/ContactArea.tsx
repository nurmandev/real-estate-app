...
const address_data: DataType[] = [
  {
    ...
    address_1: "info@omnisproperties.com",
  },
  {
    id: 2,
    class_name: "skew-line",
    title: "Our hotline number",
    address_1: "+971 58 825 1088",
  },
  {
    id: 3,
    title: "Our Location",
    address_1: "Business Bay, Dubai, UAE",
  },
];
            ...
            <div className="contact-map-banner w-100">
              <div className="gmap_canvas h-100 w-100">
                <iframe
                  ...
                  src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Business Bay, Dubai, UAE&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                ></iframe>
              </div>
            </div>
          </div>
