        ...
        <div className="container">
          <div className="title-one text-center mb-70 xl-mb-40 lg-mb-20">
            <h2 className="font-garamond star-shape">
              ...
              Off-Plan, Resale & Rentals
            </h2>
            <p className="fs-22 mt-xs color-dark">
              Comprehensive property solutions across Dubai&apos;s most
          ...
          <div className="row justify-content-center gx-xxl-5">
            {feature_data
              ...
              .map((item) => (
                <div
                  key={item.id}
                  className="col-lg-4 col-md-6 mt-30 d-flex wow fadeInUp"
                ...
                >
                  <div className="card-style-five text-center d-inline-flex flex-column align-items-center tran3s h-100 w-100">
                    ...
                    <Link href="/listing_10" className="btn-twelve mt-auto">
                      {item.btn}
                    </Link>
                  </div>
                </div>
          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-lg-6 ms-auto">
              <p className="text-white fs-24 m0 lh-lg  wow fadeInRight">
                Omnis Properties LLC transforms your real estate goals into
                reality with expert guidance and market insights tailored for
