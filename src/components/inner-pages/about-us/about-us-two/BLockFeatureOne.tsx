          ...
          <div className="col-xl-6 col-lg-7 order-lg-last wow fadeInRight">
            <div className="ms-xxl-5 ps-xl-4 ps-lg-5 md-mb-50">
              <div className="title-one mb-45 lg-mb-20">
                ...
                <p className="fs-22">
                  Omnis Properties LLC is dedicated to providing premium
                  investment opportunities and luxury living spaces in the heart
                  of Dubai.
                </p>
              </div>
          ...
          <div className="row justify-content-center">
            <div className="col-md-4 col-sm-6">
              <div className="counter-block-two text-center dark mt-30">
                ...
                <p className="fs-20 mt-15 md-mt-10">Premium Listings</p>
              </div>
            </div>
            <div className="col-md-4 col-sm-6">
              <div className="counter-block-two text-center dark mt-30">
                ...
                <p className="fs-20 mt-15 md-mt-10">Average Investor ROI</p>
              </div>
            </div>
            <div className="col-md-4 col-sm-6">
              <div className="counter-block-two text-center dark mt-30">
                <div className="main-count sm font-garamond fw-500">
                  <span className="counter">{<Count number={1500} />}</span>+
                </div>
                <p className="fs-20 mt-15 md-mt-10">Global Investors</p>
              </div>
            </div>
          </div>
        </div>
