...
const property_data: DataType[] = [
  {
    ...
    property_info: [
      ...
      { icon: propertyIcon_2, feature: "bed", total_feature: 0o3 },
      { icon: propertyIcon_3, feature: "bath", total_feature: 0o2 },
    ],
    price: 3280,
    price_text: "m",
    carousel: "1",
  },
  {
    ...
    property_info: [
      ...
      { icon: propertyIcon_2, feature: "bed", total_feature: 0o2 },
      { icon: propertyIcon_3, feature: "bath", total_feature: 0o2 },
    ],
...

  {
    ...
    property_info: [
      { icon: propertyIcon_1, feature: "sqft", total_feature: 1850 },
  ...
  },
  {
    ...
    property_info: [
      { icon: propertyIcon_1, feature: "sqft", total_feature: 6500 },
      { icon: propertyIcon_2, feature: "bed", total_feature: 5 },
      { icon: propertyIcon_3, feature: "bath", total_feature: 6 },
    ],
    data_delay_time: "0.1s",
    price: 28000000,
    carousel: "2",
  },
  {
    ...
    property_info: [
      ...
      { icon: propertyIcon_2, feature: "bed", total_feature: 0 },
      { icon: propertyIcon_3, feature: "bath", total_feature: 2 },
    ],
    data_delay_time: "0.2s",
    price: 320000,
  ...
  },
  {
    ...
    property_info: [
      { icon: propertyIcon_1, feature: "sqft", total_feature: 2340 },
      { icon: propertyIcon_2, feature: "bed", total_feature: 0o4 },
      { icon: propertyIcon_3, feature: "bath", total_feature: 0o3 },
    ],
    price: 28100,
    carousel: "03",
  },
  {
    ...
    property_info: [
      ...
      { icon: propertyIcon_2, feature: "bed", total_feature: 0o3 },
      { icon: propertyIcon_3, feature: "bath", total_feature: 0o1 },
    ],
    price: 42500,
    carousel: "04",
  },
