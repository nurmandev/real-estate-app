...
const footer_content: ContentType = {
  ...
  desc_2: "Business Bay, Dubai, UAE | Delhi, India",
  email: "info@omnisproperties.com",
  number: "+971 58 825 1088",
                ...
                <div className="row justify-content-between">
                  {footer_data
                    ...
                    .map((item) => (
                      <div
                        key={item.id}
                        className={`${item.widget_class} col-lg-3 col-md-4`}
                      >
