...
const HeaderThree = () => {
  ...
  return (
    <>
      <header
        className={`theme-main-menu menu-overlay menu-style-five sticky-menu ${sticky ? "fixed" : ""}`}
      >
          ...
          <div className="top-header position-relative">
            <div className="d-flex align-items-center">
                  ...
                  {mounted && isAuthenticated && (
                    <li className="d-none d-md-inline-block ms-3 ms-xl-4 me-xl-4">
                      <Link
                        ...
                        className="btn-five md rounded-0"
                      >
              ...
              <div className="order-lg-2 d-none d-xxl-block">
                <p className="m0 email-text ps-5 pe-5">
                  Our Email{" "}
                  <Link href="#" className="tran3s fw-500 ms-2">
                    OMNIS@gmail.com
                  </Link>
                </p>
              </div>
