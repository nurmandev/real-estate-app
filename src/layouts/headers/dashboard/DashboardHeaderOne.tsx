          ...
          <ul className="style-none">
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${pathname === "/dashboard/message" ? "active" : ""}`}
              >
                <Image
                  src={
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${pathname === "/dashboard/properties-list" ? "active" : ""}`}
              >
                <Image
                  src={
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${pathname === "/dashboard/add-property" ? "active" : ""}`}
              >
                <Image
                  src={
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${pathname === "/dashboard/favourites" ? "active" : ""}`}
              >
                <Image
                  src={
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${pathname === "/dashboard/saved-search" ? "active" : ""}`}
              >
                <Image
                  src={
                    pathname === "/dashboard/saved-search"
